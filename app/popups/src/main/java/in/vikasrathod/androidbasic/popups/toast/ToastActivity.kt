package `in`.vikasrathod.androidbasic.popups.toast
...
import `in`.vikasrathod.androidbasic.popups.R
import `in`.vikasrathod.androidbasic.popups.databinding.ActivityToastBinding
